...
namespace main_savitch_14
{
    ...
    string game::get_user_move( ) const
    {
        ...
        if (next_mover() == HUMAN)          //let user(s) know whose turn it is
        {
            display_message("Black's move, please: ");
        }
        else
        {
            display_message("White's move, please: ");
        }
        
        getline(cin, answer);
        for (size_t i = 0; i < answer.size(); i++)		//makes all letters capital
		{
...
*/
    void game::make_human_move( )
    {
        ...
        {
            cout << "No available moves. Forced pass." << endl;
        }
